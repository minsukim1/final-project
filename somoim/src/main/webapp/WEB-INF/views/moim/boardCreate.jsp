...
<div>
		...
		<div class="col-12">
			<nav class="navbar">
				<ul class="nav nav-tabs">
					...
					<li class="nav-item">
						<a class="nav-link active" href="board.do?moimNo=${param.moimNo}&pageNo=">게시판</a>
					</li>
					<li class="nav-item">
	...
	<div class="row mt-3 mb-5 justify-content-center">
		<div class="card" style="width: 90%">
			...
			<form:form action="boardAdd.do" method="post" class="form" modelAttribute="boardForm">
				<div class="card-body">
						<div class="form-row">
						...
						<div class="form-row">
							...
							<div class="col-8">
								<textarea name="content" id="ckeditor" rows="10" cols="54"></textarea>
							</div>
						</div>
						<input type="text" hidden="hidden" name="moimNo" value="${param.moimNo}" />

...
#other-photo-body .photo-card {
 	width: 344px;
 	height: 330px;
 	margin: 6px;
}	
#other-photo-like i:hover {
	cursor: pointer;
}
#other-photo-like i{
 color:coral
...
#other-photo-body .fa-plus:hover {
	cursor: pointer;
}
#other-photo-body .fa-plus {
	color: #007BFF;
}

#other-photo-body .card-img-top {
	width: 344px;
	height: 250px;
}	
#other-photo-body .card-body{
	padding: 8px;
}
#other-photo-body .card-body p{
	...
	<div class="col-12">
		<nav class="navbar">
			<ul class="nav nav-tabs">
				...
				<li class="nav-item"><a class="nav-link active" href="/other/photo.do">사진첩</a></li>
		...
		<c:otherwise>
			<c:forEach var="photo" items="${photos }">
				<div class="card mb-4 photo-card">
					...
					<div class="card-body">
						<div class="row">
							<p class="ml-2" id="other-photo-like">
...
$(function() {
	...
	$("#other-photo-like i").click(function() {
		var $that = $(this);
